...
mainopens.Parent = mainopen
 ...
 Hub.Text = "| BLOX FRUIT SCRIPT แปลไทย localPlayer#6666 |"
...
--------------------------
local Main = Library:Tab("เมนู","rbxassetid://11446825283")
local Setting = Library:Tab("ตั้งค่า","rbxassetid://11446835336")
local Weapon = Library:Tab("อาวุธ","rbxassetid://11446859498")
local Race = Library:Tab("เผ่า V4","rbxassetid://11446900930")
local Stats = Library:Tab("ค่าพลัง","rbxassetid://11447069304")
local P = Library:Tab("ผู้เล่น","rbxassetid://11446900930")
local Teleport = Library:Tab("เทเลพอร์ต","rbxassetid://11446920523")
local Dungeon = Library:Tab("ลงดัน","rbxassetid://11446957539")
...
Setting:Toggle("รวมมอน [Normal]",true,function(value)
...
Setting:Toggle("รวมมอน [Extra+Lag]",false,function(value)
 _G.BringExtra = value
end)
...
Setting:Toggle("ตีเร็ว [New]",true,function(value)
 _G.FastAttack = value
end)
...
Main:Button("รีเฟชรอาวุธ",function()
 SelectWeapona:Clear()
 for i,v in pairs(game:GetService("Players").LocalPlayer.Backpack:GetChildren()) do
...
Main:Button("หยุดวาร์ป",function()
  topos(game:GetService("Players").LocalPlayer.Character.HumanoidRootPart.CFrame)
  _G.Clip = false
  end)

Main:Seperator(" เมนูฟาม ")
...
Main:Toggle("ออโต้ฟามเวล",_G.Auto_Farm_Level,function(value)
...
Main:Seperator("ออโต้ไปทะเล3")

Main:Toggle("ออโต้ ทะเล 3",_G.Auto_Third_World,function(value)
...
Main:Seperator("ออโต้ไปทะเล2")

Main:Toggle("ออโต้ ทะเล 2",_G.Auto_New_World,function(value)
...
Main:Dropdown("เลือกฟามมอน", tableMon, function(vu)
 SelectMonster = vu
 end)
...
local Boss = {}
    ...
    local BossName = Main:Dropdown("เลือกบอส",Boss,function(value)
       _G.Select_Boss = value
    end)
    
    Main:Button("รีเฟรชบอส ",function()
        BossName:Clear()
            for i, v in pairs(game:GetService("ReplicatedStorage"):GetChildren()) do
            if string.find(v.Name, "Boss") then
                BossName:Add(v.Name) 
...
Main:Toggle("ออโต้ฟามบอส",_G.Auto_Farm_Boss,function(value)
 _G.Auto_Farm_Boss = value
 end)

Main:Toggle("ออโต้เควสบอส",true,function(value)
...
Main:Toggle("ออโต้ฟามบอสทั้งหมด",_G.Auto_Farm_All_Boss,function(value)
...
Main:Seperator(" หาวัถุดิบ ")
 
 local SelectMaterial = Main:Dropdown("เลือก วัตถุดิบ",MaterialMethod,function(value)
 _G.SelectMaterial = value
end)

Main:Toggle("ออโต้ฟามวัตถุดิบ",_G.AutoFarmMaterial,function(t)
...
Main:Seperator(" เกาะลับ ")

Main:Toggle("ออโต้หาเกาะลับ",false,function(value)
...
Main:Toggle("ออโต้ย้ายเซิฟหาเกาะลับ",false,function(value)
 _G.Mystichop = value
end)

Main:Seperator(" กล่อง ")

Main:Toggle("ฟามกล่องแบบวาร์ป",false,function(vu)
	_G.ChestBypass = vu
end)
...
Main:Toggle("ฟามกล่องแบบบิน",_G.Grab_Chest,function(vu)
	Grab_Chest = vu
    StopTween(Grab_Chest)
	_G.Grab_Chest = vu
end)

Main:Button("ฟามกล่องบายพาส (Risk)",function()
...
Main:Toggle("ออโต้ฟามกระดูก",_G.Auto_Farm_Bone,function(value)
 _G.Auto_Farm_Bone = value
 StopTween(_G.Auto_Farm_Bone)
 end)

Main:Toggle("ออโต้สุ่มกระดูก",_G.Auto_Trade_Bone,function(value)
...
Main:Button("เช็คกระดูกในตัว", function()
...
spawn(function()
	while game:GetService("RunService").Heartbeat:wait() do
       ...
       Main:Toggle("ออโต้ฟามฮาคิสังเกต",_G.AutoObservation,function(value)
    ...
    Main:Toggle("ออโต้ฟามฮาคิสังเกตย้ายเซิฟ",_G.AutoObservation_Hop,function(value)
...
local Elite_Hunter_Status = Weapon:Label("Status")
	...
	Weapon:Toggle("ออโต้ตีอีลิค",_G.Auto_Elite_Hunter,function(value)
 _G.Auto_Elite_Hunter = value
StopTween(_G.Auto_Elite_Hunter)
end)

	
	Weapon:Toggle("ออโต้ย้ายเซิฟอีลิค",_G.Auto_Elite_Hunter_Hop,function(value)
...
Weapon:Toggle("ออโต้ตีมอนเกาะเค้ก",_G.Auto_Cake_Prince,function(value)
...
StopTween(_G.Auto_Cake_Prince)
	...
	Weapon:Toggle("ออโต้เปิดดันโมจิ",_G.Auto_Open_Dough_Dungeon,function(value)
...
Weapon:Seperator(" กีต้าร์ ")

Weapon:Toggle("ออโต้กีต้าร์",_G.AutoNevaSoulGuitar,function(value)
...
Weapon:Toggle("ออโต้ย้ายเซิฟกีต้าร์",false,function(value)
  _G.soulGuitarhop = value    
 end)

Weapon:Seperator(" ดาบคู่โอเด้ง ")

Weapon:Toggle("ออโต้ทำเควสดาบคู่(ไม่ทำงาน)",_G.AutoCdk,function(value)
 _G.AutoCdk = value
end)
...
Weapon:Seperator(" ออโต้ดาบแชงค์ ")

Weapon:Toggle("ออโต้ทำดาบแชงค์",_G.AutoSaber,function(value)
				_G.AutoSaber = value
			end)
			
			Weapon:Toggle("ออโต้ย้ายเซิฟทำดาบแชงค์",_G.AutoSaberHop,function(value)
...
Weapon:Seperator(" เควสบาโท ")

Weapon:Toggle("ออโต้เควสบาโท",_G.Auto_Bartilo_Quest,function(value)
 _G.Auto_Bartilo_Quest = value
StopTween(_G.Auto_Bartilo_Quest)
end)

Weapon:Seperator(" เผ่า V2 ")

Weapon:Toggle("ออโต้ ทำ เผ่า [V2]",_G.Auto_Evo_Race_V2,function(value)
...
Weapon:Seperator(" ดาบโซโล ")

Weapon:Toggle("ออโต้ซื้อดาบโซโล",_G.AutoBuyLegendarySword,function(Value)
		...
		Weapon:Toggle("ออโต้ย้ายเซิฟซื้อดาบโซโล",_G.AutoBuySwordHop,function(Value)
...
Weapon:Seperator(" สีฮาคิ ")

	Weapon:Toggle("ออโต้ซื้อสีฮาคิ",_G.Auto_Buy_Enchancement,function(value)
...
StopTween(_G.Auto_Buy_Enchancement)
	...
	spawn(function()
		...
		Weapon:Seperator(" ดาบเรนโกคุ ")

	Weapon:Toggle("ออโต้ดาบเรนโกคุ",_G.Auto_Rengoku,function(value)
...
StopTween(_G.Auto_Rengoku)
	...
	spawn(function()
		...
		Weapon:Seperator(" แว่นโดฟา ")

Weapon:Toggle("ออโต้แว่นโดฟา",_G.Auto_Swan_Glasses,function(value)
 _G.Auto_Swan_Glasses = value
StopTween(_G.Auto_Swan_Glasses)
end)


	Weapon:Toggle("ออโต้ย้ายเซิฟแว่นโดฟา",_G.Auto_Swan_Glasses_Hop,function(value)
...
StopTween(_G.Auto_Soul_Reaper_Hop)
	...
	spawn(function()
		...
		Weapon:Seperator(" ยามะ ")
	
	Weapon:Toggle("ออโต้ดาบยามะ",_G.Auto_Yama,function(value)
	 _G.Auto_Yama = value
	...
	spawn(function()
		...
		Weapon:Seperator(" ฮาคิสีรุ้ง ")
	
	Weapon:Toggle("ออโต้ฮาคิรุ้ง",_G.Auto_Rainbow_Haki,function(value)
 _G.Auto_Rainbow_Haki = value
StopTween(_G.Auto_Rainbow_Haki)
end)

	
	Weapon:Toggle("ออโต้ย้ายเซิฟฮาคิสีรุ้ง",_G.Auto_Rainbow_Haki_Hop,function(value)
...
Weapon:Seperator(" ทูชิตะ ")

Weapon:Toggle("ออโต้ทำดาบ ทูชิตะ",_G.Autotushita,function(value)
...
Weapon:Toggle("ออโต้จุดคบเพลิง",_G.Auto_Holy_Torch,function(value)
...
Weapon:Seperator(" ฮาคิสังเกต V2 ")

Weapon:Toggle("ออโต้ฮาคิสังเกตV2",_G.AutoObservationHakiV2,function(x)
...
Race:Toggle("ปิดบรรไดไร้สิ้นสุด", nil, function(value)
...
Stats:Toggle("ออโต้อัพหมัด",_G.Auto_Stats_Melee,function(value)
...
Stats:Toggle("ออโต้อัพป้องกัน",_G.Auto_Stats_Defense,function(value)
...
Stats:Toggle("ออโต้อัพดาบ",_G.Auto_Stats_Sword,function(value)
...
Stats:Toggle("ออโต้อัพปืน",_G.Auto_Stats_Gun,function(value)
...
Stats:Toggle("ออโต้อัพผล",_G.Auto_Stats_Devil_Fruit,function(value)
...
Playerslist = {}
    ...
    P:Button("รีเฟรช ผู้เล่น",function()
        Playerslist = {}
        SelectedPly:Clear()
        for i,v in pairs(game:GetService("Players"):GetChildren()) do  
...
P:Toggle("ดู ผู้เล่น",_G.Spectate_Player,function(value)
...
P:Toggle("วาร์ปไปหาผู้เล่น",_G.Teleport_to_Player,function(value)
...
P:Toggle("ออโต้ฆ่าผู้เล่น [Melee]",_G.Auto_Kill_Player_Melee,function(value)
...
P:Toggle("ออโต้ฆ่าผู้เล่น [Gun]",_G.Auto_Kill_Player_Gun,function(value)
...
Teleport:Seperator(" โลก ")
 
 Teleport:Button("ไปโลก1",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelMain")
  end)
 
 Teleport:Button("ไปโลก2",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelDressrosa")
 end)

 
 Teleport:Button("ไปโลก3",function()
  game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("TravelZou")
  end)
 
 Teleport:Button("ไปหาเจ้าทะเล",function()
 ...
 Teleport:Button("บายพาส",function()
		 _G.Instant = true
...
if World1 then
    Dungeon:Label("ใช้ได้ในโลก 2 3 เท่านั้น!")
end

if World2 or World3 then
Dungeon:Seperator("ใช่ในดันเท่านั้น!")
