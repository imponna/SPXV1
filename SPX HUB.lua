...
local Library = DarkraiX:Window("SAPONDxHUB","Blox-Fruit","RightAlt",Enum.KeyCode.RightControl);
...
local Setting = Library:AddTab("Setting")
--------------------------------------------------------------------
...
Settings:AddSeperator("Kill Settings")

Settings:AddToggle("Kill Aura",_G.Kill_Aura,function(value)
 _G.Kill_Aura = value  
end)
